import { Directive, Input, Output, TemplateRef, ElementRef, HostListener, ComponentRef } from '@angular/core';
...
export class ToolTipRendererDirective {
  ...
  @Input(`dynamicTooltip`) text: string;
  ...
  show() {
    ...
    if (this._overlayRef && !this._overlayRef.hasAttached()) {
      const tooltipRef: ComponentRef<DynamicTooltipComponent> = this._overlayRef.attach(new ComponentPortal(DynamicTooltipComponent));
